...
local file_bot = io.open("plugins/"..file,"r")
if file_bot then
io.close(file_bot)
...
local file = name_t[2]..'.lua'
local file_bot = io.open("plugin/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/tshakeab/files_tshake/master/files_tshake/"..file)
if res == 200 then
local chek = io.open("plugin/"..file,'w+')
